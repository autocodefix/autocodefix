...
export const metadata: Metadata = {
  title: 'Contact | AUTO CODE FIX',
  description: 'Get in touch with AUTO CODE FIX. We are here to help with any questions about OBD2 codes, vehicle diagnostics, or repair guidance.',
}
    ...
    <main style={{ minHeight: '100vh', background: 'var(--dark)' }}>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '4rem 2rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          ...
          {/* Email */}
          <a href="mailto:admin@autocodefix.com" style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: '0.75rem' }}>
              {[
                { href: 'https://facebook.com', label: 'Facebook', icon: '📘', color: '#0163E0' },
                { href: 'https://x.com', label: 'X', icon: '🐦', color: '#fff' },
                { href: 'https://instagram.com', label: 'Instagram', icon: '📸', color: '#d6249f' },
                { href: 'https://tiktok.com', label: 'TikTok', icon: '🎵', color: '#fff' },
              ].map(s => (
          ...
          <div style={{
            ...
            color: 'var(--muted)', fontSize: '0.82rem', lineHeight: 1.7,
          }}>
        ...
        <div style={{
          ...
          <h2 style={{
            fontFamily: 'var(--font-bebas)', fontSize: '1.8rem',
            letterSpacing: 2, color: 'var(--text)', marginBottom: '1.5rem',
          }}>
...
function ContactForm() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      <div>
        <label style={{ display: 'block', fontSize: '0.75rem', color: 'var(--muted)', textTransform: 'uppercase', letterSpacing: 1, marginBottom: '0.4rem' }}>Your Name</label>
        <input
          type="text"
      ...
      <div>
        <label style={{ display: 'block', fontSize: '0.75rem', color: 'var(--muted)', textTransform: 'uppercase', letterSpacing: 1, marginBottom: '0.4rem' }}>Email Address</label>
        <input
          type="email"
      ...
      <div>
        <label style={{ display: 'block', fontSize: '0.75rem', color: 'var(--muted)', textTransform: 'uppercase', letterSpacing: 1, marginBottom: '0.4rem' }}>Subject</label>
        <input
          type="text"
          placeholder="e.g. Question about P0300 code"
          style={{
            width: '100%', padding: '0.75rem 1rem',
            background: 'var(--dark3)', border: '1px solid var(--border)',
            borderRadius: 8, color: 'var(--text)', fontSize: '0.9rem',
      ...
      <a
        href="mailto:admin@autocodefix.com"
        style={{
